...
$("#new-product").on("click", function () {
    ...
    $('#input-product-product-id').attr("detail-product-id", id);
...
$(".edit-product").on("click", function () {
    ...
    axios.get("/api/size-color/detail/" + pdInfo).then(function(res){

        if(res.data.success) {
            dataProduct.id = res.data.data.id;
            $("#input-product-color").val(res.data.data.color);
...
$(".btn-save-product").on("click", function () {
    if($("#input-product-color").val() === "" || $("#input-product-amount").val() === "" || $("#input-product-price").val()==="") {
        swal(
            'Error',
    ...
    var productId = $("#input-product-product-id").attr("detail-product-id");
    ...
    var linkPost = "/api/size-color/create";
    if(dataProduct.id) {
        linkPost = "/api/size-color/update/" + dataProduct.id;
    }
