...
public class UserService {
    ...
    public User findByEmailAndPassword(String email,String reset) {
        return StreamSupport
                .stream(userRepository.findByEmailAndPassword(email,reset).spliterator(), false)
                .findFirst().orElse(null);
    }
    ...
    public  List<Integer> findRoleByUser(Integer userId){
        return userRepository.findRoleByUser(userId);
    }
}
